    ...
    try
    {
        ...
        while (input)
        {
            ...
            if (input)
            {
                ...
                else if (operation == "SET_FRONT")
                {
                    int value;
                    input >> value;
                    std::cout << "Setting front the value "
                              << value << " ... ";
                    array.set_front(value);
                    std::cout << "ok." << std::endl;
                }
                else if (operation == "SET_BACK")
                {
                    int value;
                    input >> value;
                    std::cout << "Setting back the value "
                              << value << " ... ";
                    array.set_back(value);
                    std::cout << "ok." << std::endl;
                }
